    ...
    <div className="bg-white">
              ...
              <div className="max-w-lg">
                ...
                >
                  ...
                  <p className="mt-6 text-lg leading-8 text-gray-600">
                    We're on a mission to revolutionize professional networking by making it more meaningful and accessible.
                  </p>
                </motion.div>
              </div>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Networker was founded in 2024 with a simple idea: professional networking should be more than just collecting connections. We believe in creating meaningful relationships that drive career growth and industry innovation.
          </p>
        </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              These principles guide everything we do at Networker.
            </p>
          </div>
          <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-16">
            ...
            <div className="relative pl-9">
              ...
              <dd className="inline">
                We build trust through transparency and secure connections.
              </dd>
            </div>
            <div className="relative pl-9">
              <dt className="inline font-semibold text-gray-900">
              ...
              <dd className="inline">
                We help professionals grow through meaningful connections.
              </dd>
            </div>
            <div className="relative pl-9">
              <dt className="inline font-semibold text-gray-900">
